        ...
        return {
            ...
            ':function:exit': (node) => {
                ...
                if (signature && hasMultipleReturnTypes(signature, checker)) {
                    ...
                    context.report({
                        message: utils_1.toEncodedMessage('Refactor this function to always return the same type.', stmts, stmts.map(retStmt => `Returns ${prettyPrint(utils_1.getTypeFromTreeNode(retStmt.argument, services), checker)}`)),
