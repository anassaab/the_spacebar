...
exports.rule = utils_express_1.Express.SensitiveMiddlewarePropertyRule(findFalseContentSecurityPolicyPropertyFromHelmet, `Make sure not enabling content security policy fetch directives is safe here.`);
/**
...
function findFalseContentSecurityPolicyPropertyFromHelmet(context, node) {
    ...
    if (callee.type === 'Identifier' &&
        ...
        sensitive = utils_1.getPropertyWithValue(context, args[0], CONTENT_SECURITY_POLICY, false);
    }
