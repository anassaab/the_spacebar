        ...
        return {
            CallExpression: (node) => {
                ...
                if (utils_1.isCallToFQN(context, callExpression, 'helmet', 'dnsPrefetchControl')) {
                    sensitive_arguments_1.checkSensitiveCall(context, callExpression, 0, 'allow', true, MESSAGE);
                }
                ...
                if ((calledModule === null || calledModule === void 0 ? void 0 : calledModule.value) === 'helmet') {
                    sensitive_arguments_1.checkSensitiveCall(context, callExpression, 0, 'dnsPrefetchControl', false, MESSAGE);
                }
