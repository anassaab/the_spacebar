...
const sensitive_arguments_1 = require("../utils/sensitive-arguments");
...
exports.rule = {
    ...
    create(context) {
        ...
        function isInvalidSanitizerFunction(node) {
            ...
            if (!assignedFunction && node.type === 'Identifier' && isRequiredParserServices_1.isRequiredParserServices(services)) {
        ...
        return {
            CallExpression: (node) => {
                ...
                if (utils_1.isCallToFQN(context, callExpression, 'handlebars', 'compile')) {
                    sensitive_arguments_1.checkSensitiveCall(context, callExpression, 1, 'noEscape', true, MESSAGE);
                }
                if (utils_1.isCallToFQN(context, callExpression, 'marked', 'setOptions')) {
                    sensitive_arguments_1.checkSensitiveCall(context, callExpression, 0, 'sanitize', false, MESSAGE);
                }
                ...
                if ((calleeModule === null || calleeModule === void 0 ? void 0 : calleeModule.value) === 'markdown-it') {
                    sensitive_arguments_1.checkSensitiveCall(context, callExpression, 0, 'html', true, MESSAGE);
                }
            },
            NewExpression: (node) => {
                ...
                if ((module === null || module === void 0 ? void 0 : module.value) === 'kramed' && utils_1.isIdentifier(callee.property, 'Renderer')) {
                    sensitive_arguments_1.checkSensitiveCall(context, newExpression, 0, 'sanitize', false, MESSAGE);
                }
            },
