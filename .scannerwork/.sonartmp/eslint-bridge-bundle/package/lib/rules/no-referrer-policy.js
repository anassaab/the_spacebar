...
exports.rule = utils_express_1.Express.SensitiveMiddlewarePropertyRule(findNoReferrerPolicyPropertyFromHelmet, `Make sure disabling strict HTTP no-referrer policy is safe here.`);
function findNoReferrerPolicyPropertyFromHelmet(context, node) {
    ...
    if (args.length === 1) {
        ...
        if (isHelmetModuleNode(context, callee) && options.type === 'ObjectExpression') {
            sensitive = utils_1.getPropertyWithValue(context, options, REFERRER_POLICY, false);
        }
            ...
            if (isHelmetModuleNode(context, object) &&
                ...
                const maybePolicy = utils_1.getObjectExpressionProperty(options, POLICY);
...
function isHelmetModuleNode(context, node) {
    var _a;
    return node.type === 'Identifier' && ((_a = utils_1.getModuleNameOfNode(context, node)) === null || _a === void 0 ? void 0 : _a.value) === HELMET;
}
